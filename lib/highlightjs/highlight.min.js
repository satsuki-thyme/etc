...
;hljs.registerLanguage("markdown",e)})();/*! `dns` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("dns",d)})();/*! `ruby` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
